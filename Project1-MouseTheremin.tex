...
%----------------------------------------------------------------------------------------
\index{Run the Code}\marginlabel{Run the Code}
Run the sc code
...
See if you can figure out what to do without any further guidance from me.
